...
################################################
vpc_cidr             = "11.0.0.0/16"                # CIDR block for the VPC
...
public_subnet_cidrs   = ["11.0.3.0/24", "11.0.4.0/24"]   # List of CIDR blocks for public subnets
private_subnet_cidrs  = ["11.0.13.0/24", "11.0.14.0/24"] # List of CIDR blocks for private subnets
...
key_pair_name = "ise-test-nv-euc1" # Name of the key pair for SSH access
